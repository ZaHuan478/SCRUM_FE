...
const HeroSection = ({ onSearch }: HeroSectionProps) => {
  ...
  return (
    <section className="relative overflow-hidden bg-white px-lg py-[48px] md:px-xxl md:py-[80px]">
      <div className="relative mx-auto max-w-[1366px]">
        ...
        <div className="relative grid overflow-hidden rounded-[16px] border border-[#e8e8e8] bg-white shadow-[0_2px_8px_rgba(26,26,26,0.08)] md:grid-cols-2">
          <div className="relative min-h-[320px] bg-[#f7f7f7] md:min-h-[520px]">
            <Image
              ...
              src={heroImage}
            />
            <div className="absolute bottom-md left-md right-md rounded-[16px] border border-[#e8e8e8] bg-white/95 p-md shadow-[0_2px_8px_rgba(26,26,26,0.08)] backdrop-blur-sm">
              <div className="flex items-center gap-md">
                <div className="flex h-12 w-12 items-center justify-center rounded-[8px] bg-[#1a1a1a] text-white">
                  <Icon name="verified" />
                </div>
                <div className="min-w-0">
                  <p className="font-label-md text-label-md text-[#1a1a1a]">{t('home.hero.verified')}</p>
                    ...
                    <div className="hero-doctor-rail flex w-max items-center gap-sm">
                      {animatedDoctorImages.map((image, index) => (
                        <Image
                          ...
                          className="h-10 w-10 shrink-0 rounded-[4px] border border-[#e8e8e8] object-cover"
                          fallbackClassName="h-10 w-10 shrink-0 rounded-[4px] border border-[#e8e8e8]"
                          key={`${image}-${index}`}
                          src={image}
                        />
                      ))}
          ...
          <div className="flex flex-col justify-center p-xl md:p-[64px]">
            <span className="mb-md inline-flex w-fit rounded-[8px] border border-[#1a1a1a] bg-white px-md py-xs font-label-md text-label-md text-[#1a1a1a]">
              {t('home.hero.badge')}
            </span>
            <h1 className="mb-lg max-w-3xl font-display-lg text-[42px] font-medium leading-none tracking-normal text-[#1a1a1a] md:text-[72px]">
              {t('home.hero.titleStart')} <span>{t('home.hero.titleHighlight')}</span>
            </h1>
            <p className="mb-xxl max-w-xl font-body-lg text-body-lg leading-[1.33] text-[#3d3d3d]">
