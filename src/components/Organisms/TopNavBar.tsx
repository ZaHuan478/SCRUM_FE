    ...
    <header className="sticky top-0 z-50 bg-surface/90 shadow-sm backdrop-blur-md">
      <nav className="mx-auto flex w-full max-w-7xl items-center justify-between gap-md px-lg py-md md:px-xxl">
        ...
        <div className="flex items-center gap-md">
          ...
          <Link className="rounded-lg bg-primary-container px-lg py-sm font-label-md text-label-md text-on-primary-container transition-all hover:shadow-lg active:scale-95" to="/appointments/new">
            Đặt lịch ngay
          </Link>
        </div>
      </nav>
